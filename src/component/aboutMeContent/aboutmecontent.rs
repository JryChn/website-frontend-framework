    ...
    rsx! {
        div { id: "about_me_content", class: "w-screen min-h-[800px]",
            div {
                ...
                div {
                    id: "description",
                    class: "absolute w-96 h-28 top-56 left-4",
                    div { class: "relative w-12 border-t border-black" }
                    div { class: "w-full h-full my-2 text-sm font-normal text-left tracking-normal",
                        "/* Some words"
                    }
                }
            }
            div { id: "circle", class: "absolute w-96 h-40 top-[411px] left-96",
                div {
                    id: "circle_1",
        ...
        div { class: "absolute w-5/6 h-60 mx-auto bg-[rgb(249,248,248)] shadow-[0_4px_4px_0_rgba(0,0,0,0.25)] translate-x-1/2 right-1/2 -translate-y-2/3 flex",
            ...
            div { class: "relative w-2/3 flex flex-col",
                div { class: "relative h-1/3",
                    div { class: "absolute w-20 h-14 flex flex-row items-center justify-center bottom-0 text-lg font-medium",
                        "About Me"
                    }
                }
                div { class: "border border-b-black w-5/6" }
                div { class: "relative left-8 flex-1 w-5/6 my-6 font-normal text-left",
        ...
        div { class: "bg-[rgb(195,201,195)] h-[1000px]" }
        div { class: "relative bg-transparent -top-48",
            div { class: "inline-block text-5xl font-medium m-12", "技能和技巧" }
            div { class: "w-5/6 bg-[rgb(27,46,77)] h-96 mx-auto flex",
                div { class: "w-1/2 flex items-center justify-center", div { class: "border-gray-950 border-2 w-56 h-56" } }
                div { class: "w-1/2",
                    div { class: "absolute top-52 -translate-x-12 text-4xl font-normal text-white",
                        "Skill Title"
                    }
                    div { class: "absolute top-72 w-96 text-lg text-white font-light",
